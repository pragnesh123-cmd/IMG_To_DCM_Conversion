...
class Conversion:
    ...
    def main(self):
        ...
        try:
            ...
            self.convert(img_file,metadata_json_file)
            ...
            for dcm_file in list_dcms:
                ...
                if (available_num_tags==total_tags):
                    ...
                    if (elem == self.expected_frames):
                        ...
                        print("We do not have any DICOM file where expected number of frames are matching with data")
    ...
    def mapping_json_metadata(self,series_tag_values,new_img):
        ...
        try:
            if Path(self.json_file).is_file():
                ...
                self.commands.append("block.add_new(0x10,'LO','')")
                self.commands.append("block.add_new(0x11,'LO','')")   
                self.commands.append("block.add_new(0x12,'LO','')")
